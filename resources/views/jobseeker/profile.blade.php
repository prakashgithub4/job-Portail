                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active height-100-p" id="setting" role="tabpanel">
                                ...
                                <div class="profile-setting">
                                    <form id="profile" action="{{route('jobseeker.profile')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <ul class="profile-edit-list row">
                                            <li class="weight-500 col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label>Skills <small style="color:red">*</small></label>
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <input class="form-control form-control-lg " type="number" name="exp" value="{{$userdata->profile->experience}}" required/>
                                                </div> 
                                                <div class="form-group">
                                                    <label>Age</label>
                                                    <input class="form-control form-control-lg " type="number" name="age" value="{{$userdata->profile->age}}" required/>
                                                </div> 
                                                 <div class="form-group">
                                                    <label>Resume<small style="color:red">*</small></label>
                                                    <div class="d-flex">
                                                        <div class="custom-control custom-radio mb-5 mr-20">
                                                            <input class="form-control form-control-lg" type="file" name="cv" />
                                                         </div>
                                                   <span>*pdf,*doc</span>
