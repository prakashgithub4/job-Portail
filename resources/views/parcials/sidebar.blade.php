        ...
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li><a href="{{route('employeer')}}">Dashbord</a></li>
                       
                    </ul>
                </li>

                <li class="dropdown">
                    <a href="{{route('candidate')}}" class="dropdown-toggle">
                        <span class="micon dw dw-apartment"></span><span class="mtext">Candidate</span>
                    </a>
                    <ul class="submenu">
               ...
               <li class="dropdown">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="{{route('employer.job.create')}}">Add</a></li>
