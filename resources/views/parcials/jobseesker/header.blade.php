                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <div class="notification-list mx-h-350 customscroll">
                        <ul>
                            ...
                            <li>
                                <a href="#">
                                    <img src="{{asset('assets/vendors/vendors/images/photo2.jpg')}}" alt="">
                            ...
                            <li>
                                <a href="#">
                                    <img src="{{asset('assets/vendors/vendors/images/photo3.jpg')}}" alt="">
                                    <h3>John Doe</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
                                </a>
                            </li>
        ...
        <div class="user-info-dropdown">
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                    <a class="dropdown-item" href="{{Route('jobseeker.profile.info')}}"><i class="dw dw-user1"></i> Profile</a>
                    {{-- <a class="dropdown-item" href="profile.html"><i class="dw dw-settings2"></i> Setting</a>
                    <a class="dropdown-item" href="faq.html"><i class="dw dw-help"></i> Help</a> --}}
                    <a class="dropdown-item" href="{{url('jobseeker/logout')}}"><i class="dw dw-logout"></i> Log Out</a>
                </div>
            </div>
        </div>
